defmodule WebsiteWeb.HomeLive do
  ...
  def render(assigns) do
    ...
    <div class="py-10 px-4 sm:py-16 sm:px-12 xl:py- xl:px-20">
      <div class="lg:max-w-xl xl:max-w-2xl">
        ...
        <h1 class="mt-8 text-3xl text-neutral-200 font-extrabold">Basile Nouvellet</h1>
        <p class="max-w-2xl mt-4 text-neutral-400">
        ...
        <div>
            ...
            <:action>
              <.link
                ...
                class={[
                  ...
                  "text-sm text-neutral-400 hover:text-neutral-200 hover:bg-neutral-700",
              ...
              >
                ...
                <Heroicons.arrow_right
                  mini
                  class="ml-2 h-3.5 w-3.5 text-neutral-500 group-hover:text-neutral-300 group-hover:translate-x-0.5 transition"
                />
              </.link>
            </:action>
          </.section_title>
          ...
          <div class="w-fit mt-4 flex flex-wrap gap-6 text-sm text-neutral-400">
            <.link_with_icon url="https://twitter.com/basilenouvellet" label="basilenouvellet">
              <:icon>
                <svg
                  ...
                  aria-hidden="true"
                  fill="currentColor"
                  class="h-4 w-4 text-neutral-500 group-hover:text-neutral-100 transition"
                >
  ...
  def section_title(assigns) do
    ...
    <div class={["flex items-baseline space-x-4", @class]}>
      <h2 class="text-base text-neutral-200 font-bold"><%= render_slot(@title) %></h2>
      <%= render_slot(@action) %>
    </div>
    """
  end
