...
#       Check which version is available on https://hub.docker.com/r/hexpm/elixir/tags?page=1&name=1.14.3-erlang-25.2.2-alpine.
#
...
ARG MIX_ENV="prod"
COPY --from=release --chown=nobody:root /app/_build/${MIX_ENV}/rel/website .
